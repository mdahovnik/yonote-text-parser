...
chrome.runtime.onInstalled.addListener(() => {
  const settings: SettingList = {
    ...
    text: [
      {name: "STRONG", title: "Bold", checked: true},
      {name: "EM", title: "Italic", checked: true},
      {name: "U", title: "Underline", checked: true},
      {name: "DEL", title: "Strike", checked: true},
      {name: "CODE", title: "Code", checked: true},
    ],
    count: [
